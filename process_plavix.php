...
if(isset($_POST['CYP2C19'], $_POST['weight'], $_POST['height'], $_POST['age'], $_POST['gender'])){
	...
	$CYP2C19 = $_POST['CYP2C19'];
	$VKORC1 = $_POST['VKORC1'];

	if (($CYP2C19 == 'Variant2') || ($CYP2C19 == 'Variant3')) {
	...
	<div id="index">
		...
		<div class="container-fluid"> 
			...
			<div class="bs-docs-section">
				<h2 id="" class="page-header">Verification for Plavix </h2>
				<?php
					if($validity = 0){
						echo "You should consider some other medication."; 
					}
					elseif ($validity = 1) {
						echo "Plavix is compatible with the patient's genome.";
					}
				?>
				<p>
			...
			<div class="bs-docs-section">
				<h2 id="form_link" class="page-header">Recomemnded Dosage </h2>
				<?php 
